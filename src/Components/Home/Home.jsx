    ...
    <section id="home" className="relative px-[4rem] bg-black  w-full h-screen grid grid-cols-1 md:grid-cols-2 overflow-hidden transition-all delay-50 ease-in">
      ...
      <div className="flex flex-col gap-[2rem]  z-[2] items-center  order-2 md:justify-center  md:order-1 ">
        <div className="flex flex-col gap-3">
          <h1 className="text-white text-center font-roboto font-bold text-5xl  md:text-6xl ">
            Hello Im Andrew Roi
          </h1>
          <h1 className="text-white text-center font-roboto font-bold text-4xl  md:text-2xl lg:text-5xl">
            Im a web developer
          </h1>
        </div>
        <div className="flex justify-center">
          <button className=" bg-white px-4 py-2 rounded-full font-roboto text-black font-bold text-2xl  md:text-2xl  ">
            This is my projects
          </button>
        </div>
      </div>
